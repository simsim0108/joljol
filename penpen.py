...
def main(): # 메인 루프
    global key, koff, idx, tmr, stage, source, nokori
    tmr = tmr + 1
    draw_screen()
    ...
    if idx == 5: # 엔딩
        if tmr < 60:
            xr = 8 * tmr
            yr = 6 * tmr
            canvas.create_oval(360 - xr, 270 - yr, 360 + xr, 270 + xr, fill="black", tag="SCREEN")
        else:
